...
public class LongestPalindromicSubsequence {
	...
	public static void main(String[] args) {
		...
		// since we are not given the other string, we will make our own string by using the property of a palindrome
		...
		System.out.println("Length of longest palindrome is : " + " " + longestPalindromicSubsequence(X, Y, m, n));
	}

	// this method returns length of the longest common super-sequence
	private static int longestPalindromicSubsequence(char[] X, char[] Y, int m, int n) {
