...
//		http.csrf().disable().authorizeRequests().antMatchers("/api/ticket/**").hasAnyRole("user").and().formLogin();
...
//		auth.inMemoryAuthentication().withUser("mike").password("mike").roles("user", "admin");
//	}
//}
